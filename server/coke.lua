...
AddEventHandler('ps-drugprocessing:processCocaLeaf', function()
	...
	TriggerClientEvent('ps-drugprocessing:CheckForMoreCoke', src, src, "ProcessCoke")
end)
...
AddEventHandler('ps-drugprocessing:processCocaPowder', function()
	...
	TriggerClientEvent('ps-drugprocessing:CheckForMoreCoke', src, src,"CutCokePowder")
end)
...
AddEventHandler('ps-drugprocessing:processCocaBrick', function()
	...
	TriggerClientEvent('ps-drugprocessing:CheckForMoreCoke', src, src,"ProcessBricks")
end)
